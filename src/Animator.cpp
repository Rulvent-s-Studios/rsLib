...
bool rsLib::Animator::animate(float delta, bool X, bool Y, sf::RectangleShape& effected , sf::Vector2f to, float  time  , float startValue, float changeInValue, float  duration )
{
